...
export default function AdminLayout() {
  ...
  return (
    <div className="h-screen bg-[#faf8f5] flex">
      ...
      {/* Sidebar */}
      <aside className={`fixed lg:relative inset-y-0 left-0 z-50 w-64 shrink-0 bg-[#2c2825] text-white flex flex-col transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
